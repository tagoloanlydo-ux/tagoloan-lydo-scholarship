...
<head>
    ...
    <title>Mayor Staff Applicants Report</title>
    ...
    <div class="page">
        <div class="container">
            ...
            <div class="content-wrapper">
                        ...
                        <tr class="compact-row">
                            ...
                            <td class="text-center">
                                @if($applicant->initial_screening === 'Approved')
                                    <span class="status-approved">Approved by Mayor</span>
                                @elseif($applicant->initial_screening === 'Rejected')
                                    <span class="status-rejected">Rejected</span>
                                @elseif($applicant->initial_screening === 'Reviewed')
                                    <span class="status-reviewed">Reviewed by LYDO</span>
                                @else
                ...
                @else
                <div class="no-data">
                    <h3>No Mayor Staff Applicants Found</h3>
