...
<div class="p-2 md:p-4 border-t">
    <form method="POST" action="{{ route('logout') }}" id="logoutForm">
        @csrf
        <button type="submit" class="flex items-center p-2 text-red-600 hover:bg-red-600 hover:text-white rounded-lg w-full text-left transition-colors duration-200">
            <i class="fas fa-sign-out-alt mx-auto md:mx-0 mr-2"></i>
