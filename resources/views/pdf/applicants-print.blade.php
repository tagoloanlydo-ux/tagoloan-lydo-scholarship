...
<div class="footer">
    ...
    <span class="page-number" style="float: right;">Page 1 of 1</span>
</div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function addPageNumbers() {
            var totalPages = Math.ceil(document.querySelector('tbody').scrollHeight / 900); // Adjust based on content height
            
            // This is a simplified approach - in a real scenario, you might need a PDF library
            // or server-side pagination for accurate page numbers
            var footer = document.querySelector('.footer');
            if (footer) {
                footer.innerHTML += ' | Page 1 of ' + totalPages; // Basic implementation
            }
        }
        ...
        var pageHeight = 1122; // A4 height in pixels at 96dpi
        var totalPages = Math.ceil(contentHeight / pageHeight);
        
        var footer = document.querySelector('.footer');
        if (footer && totalPages > 0) {
            footer.innerHTML += ' | Page 1 of ' + totalPages;
        }
    });
</script>
</body>
