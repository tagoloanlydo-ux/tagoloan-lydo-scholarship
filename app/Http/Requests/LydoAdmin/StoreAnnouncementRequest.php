...
namespace App\Http\Requests\LydoAdmin;
...
class StoreAnnouncementRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'lydopers_id' => 'required|exists:tbl_lydopers,lydopers_id',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'lydopers_id.required' => 'Lydopers ID is required.',
            'lydopers_id.exists' => 'Invalid lydopers ID.',
        ];
    }
}
