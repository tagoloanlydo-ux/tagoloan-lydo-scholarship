        ...
        <script>
            ...
            function addFamilyMemberRow() {
                ...
                row.innerHTML = `
                    ...
                    <td class="border px-2 py-1">
                        <input type="date" name="family_member_birthdate[]" class="w-full border-none focus:ring-0" onchange="calculateAge(this)">
                    </td>
                    <td class="border px-2 py-1">
                        <input type="number" name="family_member_age[]" class="w-full border-none focus:ring-0" placeholder="Age" readonly>
                    </td>
                    <td class="border px-2 py-1">
