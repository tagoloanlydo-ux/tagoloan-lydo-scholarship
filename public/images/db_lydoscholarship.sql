...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 23, 2025 at 07:31 AM
...
('cagatanm23@gmail.com', '5dZIfwqTSRjcABOrDYcV7FIqCzcyZRsmgqLnAUpILc53CZunepo9ZgFLykutIn7G', '2025-08-22 18:20:55');
...
(3, 'Jose', 'Cruz', 'Manalo', NULL, 'Male', '2001-01-15', 'Single', 'Sta. Ana, Tagoloan', 'jose.manalo@example.com', '09123456783', 'PHINMA COC', '4th Year', 'BSBA', '2025-2026', '2025-08-21 12:12:37', '2025-08-21 12:12:37'),
...
(1, 1, 1, 'Approved', 'Ultra Poor', 'Approved', '2025-08-21 12:13:31', '2025-08-22 20:18:27'),
(2, 2, 1, 'Approved', 'Non Poor', 'Pending', '2025-08-21 12:13:31', '2025-08-21 12:13:31'),
(3, 3, 1, 'Approved', 'Non Poor', 'Approved', '2025-08-21 12:13:31', '2025-08-21 12:13:31'),
(4, 4, 1, 'pending', 'Poor', 'Pending', '2025-08-21 12:13:31', '2025-08-21 12:13:31'),
(5, 5, 1, 'pending', 'Non Indigenous', 'Approved', '2025-08-21 12:13:31', '2025-08-22 20:21:20'),
(6, 6, 1, 'Reviewed', 'pending', 'Pending', '2025-08-21 12:13:31', '2025-08-21 12:13:31');
...
(2, 'Joanna', NULL, 'Arias', NULL, 'P=San Martin', '2003-10-10', 'Cagatanm23@gmail.com', 9194519238, 'Arias@gmail.com', '$2y$12$13NHH9dXilKLsQKcwDZcPO73UELh79YG2sNngfvwSOqxGc3qMJtd.', 'mayor_staff', 'active', '2025-08-19 03:48:04', '2025-08-19 03:48:04'),
...
(5, 'Mark', 'samillano', 'cagatan', NULL, 'P-9 SanMartin Villanueva Mis. Or.', '2003-10-10', 'cagataknmark17@gmail.com', 9194519238, 'Arias@gmail.comk', '$2y$12$60fVDyQrnKC7/N2mQae2geISHrFA8TY8JotusR0CDbcE.G5tYdjkq', 'lydo_staff', 'inactive', '2025-08-20 20:06:54', '2025-08-20 20:06:54');
...
--
ALTER TABLE `tbl_application_personnel`
  MODIFY `application_personnel_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tbl_lydopers`
  MODIFY `lydopers_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tbl_renewal`
--
ALTER TABLE `tbl_renewal`
  MODIFY `renewal_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_scholar`
--
ALTER TABLE `tbl_scholar`
  MODIFY `scholar_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
