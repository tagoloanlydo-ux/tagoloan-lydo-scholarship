...
// ----------------------- MOBILE API ROUTES -----------------------
    ...
    Route::middleware('api.auth')->group(function () {
        ...
        // ----------------------- SCHOLAR ROUTES -----------------------
        Route::middleware('App\Http\Middleware\ApiRoleMiddleware:scholar')->prefix('scholar')->group(function () {
        ...
        // ----------------------- ADMIN ROUTES -----------------------
        Route::middleware('App\Http\Middleware\ApiRoleMiddleware:lydo_admin')->prefix('admin')->group(function () {
        ...
        Route::prefix('notifications')->group(function () {
            ...
            Route::post('/announcements', [ApiNotificationController::class, 'createAnnouncement'])->middleware('App\Http\Middleware\ApiRoleMiddleware:lydo_admin');
            Route::put('/announcements/{announcementId}', [ApiNotificationController::class, 'updateAnnouncement'])->middleware('App\Http\Middleware\ApiRoleMiddleware:lydo_admin');
            Route::delete('/announcements/{announcementId}', [ApiNotificationController::class, 'deleteAnnouncement'])->middleware('App\Http\Middleware\ApiRoleMiddleware:lydo_admin');
            Route::post('/send-email', [ApiNotificationController::class, 'sendEmail'])->middleware('App\Http\Middleware\ApiRoleMiddleware:lydo_admin');
            Route::post('/send-sms', [ApiNotificationController::class, 'sendSms'])->middleware('App\Http\Middleware\ApiRoleMiddleware:lydo_admin');
        ...
        Route::prefix('reports')->group(function () {
            ...
            Route::get('/applicants/pdf', [ApiReportController::class, 'applicantsReport'])->middleware('App\Http\Middleware\ApiRoleMiddleware:lydo_admin');
            Route::get('/scholars/pdf', [ApiReportController::class, 'scholarsReport'])->middleware('App\Http\Middleware\ApiRoleMiddleware:lydo_admin');
            Route::get('/disbursements/pdf', [ApiReportController::class, 'disbursementsReport'])->middleware('App\Http\Middleware\ApiRoleMiddleware:lydo_admin');
            Route::get('/renewals/pdf', [ApiReportController::class, 'renewalsReport'])->middleware('App\Http\Middleware\ApiRoleMiddleware:lydo_admin');
            Route::get('/summary/pdf', [ApiReportController::class, 'summaryReport'])->middleware('App\Http\Middleware\ApiRoleMiddleware:lydo_admin');
        });
    ...
    Route::prefix('disbursements')->group(function () {
        ...
        Route::post('/', [ApiDisbursementController::class, 'store'])->middleware('App\Http\Middleware\ApiRoleMiddleware:lydo_admin');
        Route::put('/{disbursementId}', [ApiDisbursementController::class, 'update'])->middleware('App\Http\Middleware\ApiRoleMiddleware:lydo_admin');
        Route::delete('/{disbursementId}', [ApiDisbursementController::class, 'destroy'])->middleware('App\Http\Middleware\ApiRoleMiddleware:lydo_admin');
        ...
        Route::post('/bulk-update-status', [ApiDisbursementController::class, 'bulkUpdateStatus'])->middleware('App\Http\Middleware\ApiRoleMiddleware:lydo_admin');
