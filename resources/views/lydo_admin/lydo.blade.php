...
<body class="bg-gray-50">
                    ...
                    <div class="max-w-6xl mx-auto">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <!-- Quick Actions Card -->
                                <div class="info-card bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden border-l-amber-500">
                                    <div class="px-6 py-4 border-b border-gray-100">
                                        <h4 class="text-lg font-bold text-gray-800 flex items-center">
                                    ...
                                    <div class="p-6">
                                        <div class="space-y-3">
                                            <button id="editProfileBtn" class="w-full flex items-center justify-center space-x-2 bg-violet-100 hover:bg-violet-200 text-violet-700 font-medium py-2 px-4 rounded-lg transition-colors">
                                                <i class="fas fa-edit"></i>
                                                <span>Edit Profile</span>
                                            </button>
                                            <button id="deleteStaffBtn" class="w-full flex items-center justify-center space-x-2 bg-red-100 hover:bg-red-200 text-red-700 font-medium py-2 px-4 rounded-lg transition-colors">
    ...
    <script>
        ...
        function openStaffModal(staffData) {
            currentStaffId = staffData.lydopers_id;
            currentStaffRole = staffData.lydopers_role;
        ...
        editProfileBtn.addEventListener('click', function() {
            if (currentStaffId) {
                ...
                window.location.href = `/lydo_admin/settings?edit_staff=${currentStaffId}`;
            }
        });
        ...
        deleteStaffBtn.addEventListener('click', function() {
            if (currentStaffId) {
                Swal.fire({
                    title: 'Are you sure?',
                    text: "You won't be able to revert this! This will permanently delete the staff member.",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        // Determine the correct delete route based on staff role
                        const deleteRoute = currentStaffRole === 'mayor_staff' 
                            ? `/lydo_admin/mayor/delete/${currentStaffId}`
                            : `/lydo_admin/lydo/delete/${currentStaffId}`;
